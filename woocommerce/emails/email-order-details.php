	...
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
		<thead>
			<tr>
				...
				<th class="td" scope="col" style="text-align:<?php echo $text_align; ?>;"><?php _e( 'Sale Price', 'woocommerce' ); ?></th>
			</tr>
		</thead>
		<tbody>
				...
				if ( $totals = $order->get_order_item_totals() ) {
					...
					foreach ( $totals as $total ) {
						...
						?><tr>
							...
							<td class="td" style="text-align:<?php echo $text_align; ?>; <?php echo ( 1 === $i ) ? 'border-top-width: 2px;' : ''; ?>"><?php echo $total['value']; ?></td>
						</tr><?php
					}
				}
