...
<?php if( $this->has_header_logo() ) echo apply_filters( 'wpo_wcpdf_packing_slip_title', __( '', 'woocommerce-pdf-invoices-packing-slips' ) ); ?>
</h1>
		...
		<td class="order-data">
			<table>
				...
				<tr class="order-number">
					<th><?php _e( 'Request Number:', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
...
?>, thank you so much and we hope that you love your cards! <br/>We love seeing how you use our designs and sharing your special moments. </div>
